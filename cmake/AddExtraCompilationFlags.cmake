...
# ViSP library. Add extra compilation flags.
#
# Authors:
# Guillaume Caron
#
...
macro(pr_add_extra_compilation_flags)
...
#  endif()
  ...
  # OpenMP
  if(USE_OPENMP)
    set(PER_OPENMP_FLAGS "${OpenMP_CXX_FLAGS}")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OpenMP_CXX_FLAGS}")
  else()
    set(PER_OPENMP_FLAGS "")
    if(OpenMP_CXX_FLAGS)
  ...
  # C++11
  if(USE_CPP11)
    set(PER_CPP11_FLAGS "${CPP11_CXX_FLAGS}")
...
endmacro(pr_add_extra_compilation_flags)
