...
/*!
 \class PER_EXPORT prParaboloid prParaboloid.h <per/prParaboloid.h>
 \brief Class for dealing with the projection functions of a paracatadioptric omnidirectional camera (adhoc model).
 */
class PER_EXPORT prParaboloid : public prCameraModel {
public:
     ...
     */
    virtual ~prParaboloid() override = default;
