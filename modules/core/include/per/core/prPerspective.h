...
/*!
 \class PER_EXPORT prPerspective prPerspective.h <per/prPerspective.h>
 \brief Class for dealing with the projection functions of a classical pinhole camera.
 */
class PER_EXPORT prPerspective : public prCameraModel
{
public:
    /*!
     ...
     */
    virtual ~prPerspective() override = default;
    ...
    bool projectImageSphere(prPointFeature &P, double &Xs, double &Ys, double &Zs);
