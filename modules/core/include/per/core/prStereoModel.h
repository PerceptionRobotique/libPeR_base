...
/*!
 \class PER_EXPORT prStereoModel prStereoModel.h <per/prStereoModel.h>
 \brief Class for dealing with rigs of sensor.
 */
class PER_EXPORT prStereoModel : public prSensorModel
{
public:
     ...
     */
    virtual ~prStereoModel() override;
     ...
     */
    prStereoModel &operator=(const prStereoModel &cam);
};
